...
export default {
    ...
    ,
     mounted(){
        fetch('https://www.googleapis.com/youtube/v3/videos/?part=snippet,contentDetails,statistics&id='+this.id+'&key=AIzaSyCC9GCpSlFnw1jFu8jmiW4KiaZ-828OK_k')
                ...
                //related video
                fetch('https://www.googleapis.com/youtube/v3/search?part=snippet&relatedToVideoId='+this.id+'&key=AIzaSyCC9GCpSlFnw1jFu8jmiW4KiaZ-828OK_k&type=video&maxResults=10&')
